    ...
    <div className={styles.aboutGrid}>
      <div className={styles.left}>
        ...
        <p className={styles.text}>
          ...
          I'm also the founder of Mindflux, a startup I started to explore how AI can be integrated into the real world; not just as a tool, but as a driver of impact. At Mindflux, we're building practical, intelligent systems that solve actual problems and making sure innovation stays grounded in purpose. -Progress, innovation, and real-world impact continue to lead the way-
        </p>
      </div>
